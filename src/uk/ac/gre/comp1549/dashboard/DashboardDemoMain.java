...
import uk.ac.gre.comp1549.dashboard.controls.PetrolBar;
import uk.ac.gre.comp1549.dashboard.controls.PetrolDial;
import uk.ac.gre.comp1549.dashboard.controls.SpeedDial;
...
public class DashboardDemoMain extends JFrame {
    ...
    private PetrolBar petrol;
     private SpeedDial dialspeed;
    private PetrolDial dialpetrol;
     

    /**
     * Constructor. Does maybe more work than is good for a constructor.
     */
     private static DashboardDemoMain single_instance = null; 
    private DashboardDemoMain() {
        ...
        // add the petrol Bar
        petrol = new PetrolBar();
        petrol.setLabel("PETROL");
        petrol.setValue(100);
       dashboard.add(petrol);
    ...
    public static DashboardDemoMain getInstance() 
    { 
        if (single_instance == null) 
            single_instance = new DashboardDemoMain(); 
        ...
        try {
            ...
            DashBoardEventListener dbelSpeed = new DashBoardEventListener() {
                ...
                public void processDashBoardEvent(Object originator, DashBoardEvent dbe) {
                    dialspeed.setValue(Integer.parseInt(dbe.getValue()));
            ...
            DashBoardEventListener dbelPetril = new DashBoardEventListener() {
                @Override
                public void processDashBoardEvent(Object originator, DashBoardEvent dbe) {
                    dialpetrol.setValue(Integer.parseInt(dbe.getValue()));
                    petrol.setValue(Integer.parseInt(dbe.getValue()));
                }
            };
    ...
    public void setPetrol() {
        try {
            ...
            dialpetrol.setValue(value);
            petrol.setValue(value);
        } catch (NumberFormatException e) {
        }
        // don't set the speed if the input can't be parsed
    }
    ...
    public static void main(String[] args) {
        ...
        final WelcomeDashboard me = new WelcomeDashboard();
    }
}
